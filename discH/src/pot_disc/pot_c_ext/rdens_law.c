...
static double __pyx_f_5discH_3src_8pot_disc_9pot_c_ext_9rdens_law_poly_exponentialpy(double, double, double, double, double, double, double, double, int __pyx_skip_dispatch); /*proto*/
...
static PyObject *__pyx_pf_5discH_3src_8pot_disc_9pot_c_ext_9rdens_law_poly_exponentialpy(CYTHON_UNUSED PyObject *__pyx_self, double __pyx_v_R, double __pyx_v_Rd, double __pyx_v_a0, double __pyx_v_a1, double __pyx_v_a2, double __pyx_v_a3, double __pyx_v_a4, double __pyx_v_a5); /* proto */
...
static double __pyx_f_5discH_3src_8pot_disc_9pot_c_ext_9rdens_law_exponential_disc(double __pyx_v_R, double __pyx_v_Rd, CYTHON_UNUSED int __pyx_v_nparam) {
  double __pyx_r;

  /* "discH/src/pot_disc/pot_c_ext/rdens_law.pyx":17
 *     """
 * 
 *     nparam=1             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "discH/src/pot_disc/pot_c_ext/rdens_law.pyx":21
 * 
 * 
 *     return exp(-R/Rd)             # <<<<<<<<<<<<<<
 * 
 * 
 */
  __pyx_r = exp(((-__pyx_v_R) / __pyx_v_Rd));
  goto __pyx_L0;
...
/* "discH/src/pot_disc/pot_c_ext/rdens_law.pyx":24
 * 
 * 
...
static double __pyx_f_5discH_3src_8pot_disc_9pot_c_ext_9rdens_law_poly_exponential(double __pyx_v_R, double __pyx_v_Rd, double __pyx_v_a0, double __pyx_v_a1, double __pyx_v_a2, double __pyx_v_a3, double __pyx_v_a4, double __pyx_v_a5) {
  double __pyx_v_res;
  double __pyx_v_recursiveR;
  double __pyx_r;

  /* "discH/src/pot_disc/pot_c_ext/rdens_law.pyx":29
...
static double __pyx_f_5discH_3src_8pot_disc_9pot_c_ext_9rdens_law_poly_exponentialpy(double __pyx_v_R, double __pyx_v_Rd, double __pyx_v_a0, double __pyx_v_a1, double __pyx_v_a2, double __pyx_v_a3, double __pyx_v_a4, double __pyx_v_a5, CYTHON_UNUSED int __pyx_skip_dispatch) {
  double __pyx_v_res;
  double __pyx_v_recursiveR;
  double __pyx_r;
 ...
 */
  ...
  /* "discH/src/pot_disc/pot_c_ext/rdens_law.pyx":55
 *     recursiveR=recursiveR*R
 *     res+=a3*recursiveR
 *     recursiveR=recursiveR*R             # <<<<<<<<<<<<<<
 *     res+=a4*recursiveR
...
static PyObject *__pyx_pw_5discH_3src_8pot_disc_9pot_c_ext_9rdens_law_1poly_exponentialpy(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_R,&__pyx_n_s_Rd,&__pyx_n_s_a0,&__pyx_n_s_a1,&__pyx_n_s_a2,&__pyx_n_s_a3,&__pyx_n_s_a4,&__pyx_n_s_a5,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_Rd)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("poly_exponentialpy", 1, 8, 8, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 43; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_a0)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("poly_exponentialpy", 1, 8, 8, 2); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 43; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_a1)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("poly_exponentialpy", 1, 8, 8, 3); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 43; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  4:
        if (likely((values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_a2)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("poly_exponentialpy", 1, 8, 8, 4); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 43; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  5:
        if (likely((values[5] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_a3)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("poly_exponentialpy", 1, 8, 8, 5); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 43; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  6:
        if (likely((values[6] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_a4)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("poly_exponentialpy", 1, 8, 8, 6); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 43; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  7:
        if (likely((values[7] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_a5)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("poly_exponentialpy", 1, 8, 8, 7); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 43; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "poly_exponentialpy") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 43; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    ...
    __pyx_v_R = __pyx_PyFloat_AsDouble(values[0]); if (unlikely((__pyx_v_R == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 43; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_Rd = __pyx_PyFloat_AsDouble(values[1]); if (unlikely((__pyx_v_Rd == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 43; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_a0 = __pyx_PyFloat_AsDouble(values[2]); if (unlikely((__pyx_v_a0 == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 43; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_a1 = __pyx_PyFloat_AsDouble(values[3]); if (unlikely((__pyx_v_a1 == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 43; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_a2 = __pyx_PyFloat_AsDouble(values[4]); if (unlikely((__pyx_v_a2 == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 43; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_a3 = __pyx_PyFloat_AsDouble(values[5]); if (unlikely((__pyx_v_a3 == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 43; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_a4 = __pyx_PyFloat_AsDouble(values[6]); if (unlikely((__pyx_v_a4 == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 43; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_a5 = __pyx_PyFloat_AsDouble(values[7]); if (unlikely((__pyx_v_a5 == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 43; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("poly_exponentialpy", 1, 8, 8, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 43; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  ...
  __pyx_r = __pyx_pf_5discH_3src_8pot_disc_9pot_c_ext_9rdens_law_poly_exponentialpy(__pyx_self, __pyx_v_R, __pyx_v_Rd, __pyx_v_a0, __pyx_v_a1, __pyx_v_a2, __pyx_v_a3, __pyx_v_a4, __pyx_v_a5);
...
static PyObject *__pyx_pf_5discH_3src_8pot_disc_9pot_c_ext_9rdens_law_poly_exponentialpy(CYTHON_UNUSED PyObject *__pyx_self, double __pyx_v_R, double __pyx_v_Rd, double __pyx_v_a0, double __pyx_v_a1, double __pyx_v_a2, double __pyx_v_a3, double __pyx_v_a4, double __pyx_v_a5) {
  ...
  __pyx_t_1 = PyFloat_FromDouble(__pyx_f_5discH_3src_8pot_disc_9pot_c_ext_9rdens_law_poly_exponentialpy(__pyx_v_R, __pyx_v_Rd, __pyx_v_a0, __pyx_v_a1, __pyx_v_a2, __pyx_v_a3, __pyx_v_a4, __pyx_v_a5, 0)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 43; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
static PyMethodDef __pyx_methods[] = {
  {"poly_exponentialpy", (PyCFunction)__pyx_pw_5discH_3src_8pot_disc_9pot_c_ext_9rdens_law_1poly_exponentialpy, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
#endif
{
  ...
  if (__Pyx_ExportFunction("poly_exponential", (void (*)(void))__pyx_f_5discH_3src_8pot_disc_9pot_c_ext_9rdens_law_poly_exponential, "double (double, double, double, double, double, double, double, double)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  /*--- Type init code ---*/
