...
#endif
{
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "discH.src.pot_halo.pot_c_ext.general_halo")) {
      if (unlikely(PyDict_SetItemString(modules, "discH.src.pot_halo.pot_c_ext.general_halo", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  if (__Pyx_ExportFunction("xi", (void (*)(void))__pyx_f_5discH_3src_8pot_halo_9pot_c_ext_12general_halo_xi, "double (double, double, double, double)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init discH.src.pot_halo.pot_c_ext.general_halo", __pyx_clineno, __pyx_lineno, __pyx_filename);
